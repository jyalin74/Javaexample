...
public class EqualsTest {
    public static void main(String[] args) {
        ...
        if (studentLee.equals(studentLee2)){
            ...
            System.out.println("studentLee와 studentLee2는 동일하지 앖습니다.");
        }
        // 주소는 다르지만 equals의 결과가 true인 경우
        if (studentLee == studentSang){
            System.out.println("studentLee와 studentSang는 조소는 같습니다.");
        } else {
            System.out.println("studentLee와 studentSang는 조소는 다릅니다.");
        }
